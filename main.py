...
def learn(i1, i2, target, alpha=0.02):
...
for epoch in range(1, 1000):
    ...
    for j in indexes:
        learn(INPUTS[j][0], INPUTS[j][0], OUTPUTS[j][0], alpha=0.02)
...
for i in range(4):
    ...
    print("for input", INPUTS[i], "expected", OUTPUTS[i][0], "predicted")
